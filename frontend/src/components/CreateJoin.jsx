  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4">
      ...
      <button
        ...
        className="fixed top-6 left-6 z-50 p-3 rounded-full bg-slate-800 hover:bg-slate-700 border-2 border-purple-500/30 hover:border-purple-500 text-purple-400 hover:text-purple-300 transition-all shadow-lg"
        title="Go to home"
      >
      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-slate-800/90 backdrop-blur-sm border-2 border-purple-500 rounded-2xl p-8 hover:border-purple-400 transition-all">
              <div className="bg-gradient-to-br from-purple-500 to-pink-500 p-4 rounded-xl w-fit mb-6 mx-auto">
                <Plus className="w-10 h-10 text-white" />
              </div>
              
              <h2 className="text-2xl font-bold text-white mb-3 text-center">Create Battle Room</h2>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-slate-800/90 backdrop-blur-sm border-2 border-blue-500 rounded-2xl p-8 hover:border-blue-400 transition-all">
              ...
              <h2 className="text-2xl font-bold text-white mb-3 text-center">Join Battle Room</h2>
              <p className="text-gray-400 text-center mb-6">
